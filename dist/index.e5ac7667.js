...
.then(()=>{
    fetch(`${baseUrl}/44`, {
        ...
        if (!data.acf.image_copy.url) productSideImg = document.querySelector("#side-img-1");
        else {
        ...
        if (data.acf.image_copy.url && !data.acf.image_copy2.url) productSideImg = document.querySelector("#side-img-2");
        if (!data.acf.image_copy.url && !data.acf.image_copy2.url) $("#side-img-2").css("display", "none");
        ...
        if (data.acf.image_copy.url && data.acf.image_copy2.url && !data.acf.image_copy3.url) productSideImg = document.querySelector("#side-img-3");
        if (data.acf.image_copy.url && !data.acf.image_copy2.url && !data.acf.image_copy3.url) $("#side-img-3").css("display", "none");
        if (!data.acf.image_copy.url && !data.acf.image_copy2.url && !data.acf.image_copy3.url) $("#side-img-3").css("display", "none");
        // Product main image
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyO8b","aitAD"], "aitAD", "parcelRequire1f81")
